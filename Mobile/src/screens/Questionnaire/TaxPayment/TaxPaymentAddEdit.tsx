...
import useTaxPaymentAddEditHook from './hooks/useTaxPaymentAddEditHook'
...
const TaxPaymentAddEdit = ({ navigation, route }: ApplicationScreenProps) => {
  ...
  const {
    ...
    onError,
    refreshPage,
  } = useTaxPaymentAddEditHook(navigation, route)
    ...
    return (
      <View>
        ...
        <NumberField
          ...
          // error={errors.curPaymentAmount?.message}
...
export default TaxPaymentAddEdit
